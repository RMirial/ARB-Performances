...
========================================-->
    ...
    <h2 data-aos="fade-up"
    data-aos-duration="3000" style="text-decoration: underline;">Nos actualités</h2>

    <!--actualités1-->

    <section data-aos="fade-up"
    data-aos-duration="3000" class="actu actu1">
    ...
    <section data-aos="fade-up"
    data-aos-duration="3000" class="actu actu2">
        <h4>TOP 10 Nogaro</h4>
    ...
    <section data-aos="fade-up"
    data-aos-duration="3000" class="actu actu3">
        <h4>TOP 10 Nogaro</h4>
        <p>Premier Top 10 pour l’équipe ARB-Performances lors de la seconde manche du Championnat de France d’Endurance.
            Sur le circuit de Nogaro, l’équipe connaîtra un weekend sans problème qui permettra d’accéder au Top 10 du
            général mais aussi à la troisième place des équipages à la française. Good job les gars !</p>
    ...
    <section data-aos="fade-up"
    data-aos-duration="3000" class="actu actu4">
        <h4>TOP 10 Nogaro</h4>
        <p>Premier Top 10 pour l’équipe ARB-Performances lors de la seconde manche du Championnat de France d’Endurance.
            Sur le circuit de Nogaro, l’équipe connaîtra un weekend sans problème qui permettra d’accéder au Top 10 du
            général mais aussi à la troisième place des équipages à la française. Good job les gars !</p>
    ...
    <section data-aos="fade-up"
    data-aos-duration="3000" class="actu actu5">
        <h4>TOP 10 Nogaro</h4>
        <p>Premier Top 10 pour l’équipe ARB-Performances lors de la seconde manche du Championnat de France d’Endurance.
            Sur le circuit de Nogaro, l’équipe connaîtra un weekend sans problème qui permettra d’accéder au Top 10 du
            général mais aussi à la troisième place des équipages à la française. Good job les gars !</p>
    ...
    <section data-aos="fade-up"
    data-aos-duration="3000" class="plus_actu">
